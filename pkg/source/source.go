...
const (
	...
	// Bridge is the source used for state derived from a key value store
	// for keys generated by szn calico-cilium-bridge
	// State in the bridged key value stored takes precedence over orchestration
	// system state such as Kubernetes but not over standard KVStore.
