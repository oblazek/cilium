...
func (m *Manager) NodeUpdated(n nodeTypes.Node) {
	...
	for _, address := range n.IPAddresses {
		...
		m.upsertIntoIDMD(prefix, remoteHostIdentity, resource, lbls)
...
// with the CIDR.
func (m *Manager) upsertIntoIDMD(prefix netip.Prefix, id identity.NumericIdentity, rid ipcacheTypes.ResourceID, lbls labels.Labels) {
